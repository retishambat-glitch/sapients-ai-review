// api/review.js – Final Perplexity-backed AI Review Generator
  ...
  try {
    ...
    if (!rating || !mood) {
      return res.status(400).json({
        error: "Missing 'rating' or 'mood' in request body."
      });
    }
...
Keep it authentic, polite, emotionally pleasant, and professional.
Limit to 3–5 sentences.
    `;

    // Read Perplexity key from Vercel environment
    ...
    const review =
      ...
      "No response from Perplexity model.";
